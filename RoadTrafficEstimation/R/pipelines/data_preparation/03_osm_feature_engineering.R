...
# ------------------------------------------------------------------------------
# Engineering of  the entire French network
# ------------------------------------------------------------------------------
if (file.exists(cfg_data$OSM_ROADS_FRANCE_ENGINEERED_FILEPATH) && 
    isFALSE(cfg_data$FORCE_REENGINEER_OSM_FRANCE)) {
...
} else if (!file.exists(cfg_data$OSM_ROADS_FRANCE_ENGINEERED_FILEPATH) || 
    isTRUE(cfg_data$FORCE_REENGINEER_OSM_FRANCE)) {
  # ----------------------------------------------------------------------------
